...
class RareGearsFragment : Fragment() {
    ...
    private var _binding: FragmentRareGearsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRareGearsBinding.inflate(inflater, container, false)

        binding.rvHelpWikiRareGears.adapter = RareGearsItemsAdapter { url ->
